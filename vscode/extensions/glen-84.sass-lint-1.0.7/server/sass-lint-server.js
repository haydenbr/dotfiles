...
connection.onInitialize((params) => {
    ...
    hasWorkspaceFolderCapability = Boolean((_a = capabilities.workspace) === null || _a === void 0 ? void 0 : _a.workspaceFolders);
    hasConfigurationCapability = Boolean((_b = capabilities.workspace) === null || _b === void 0 ? void 0 : _b.configuration);
    return {
        capabilities: {
...
function loadLibrary(docUri) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        document2Library.set(docUri, promise.then((libraryPath) => {
            ...
            yield connection.sendRequest(NoSassLintLibraryRequest.type, { source: { uri: docUri } });
        })));
    });
}

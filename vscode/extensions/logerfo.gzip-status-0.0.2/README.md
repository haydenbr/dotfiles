[![Version](https://vsmarketplacebadge.apphb.com/version-short/logerfo.gzip-status.svg)](https://marketplace.visualstudio.com/items?itemName=logerfo.gzip-status)
